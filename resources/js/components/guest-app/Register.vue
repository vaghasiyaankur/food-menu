    ...
    <div class="nav-bar">
        <div class="row align-items-center navbar-menu padding-vertical-half padding-horizontal justify-content-flex-start">
                        ...
                        <div class="row menu-item-content no-margin-top no-margin-bottom justify-content-center">
                            <div class="margin-right-half">                                
                                ...
                                <!-- <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                                    <path d="M9.18454 12.5641C9.14601 12.3715 7.81894 5.74368 7.77685 5.53366C7.71111 5.20506 7.4222 4.96851 7.08671 4.96851H5.67902C5.34352 4.96851 5.05462 5.20506 4.98888 5.53366C4.94613 5.74724 3.6177 12.3818 3.58119 12.5641C3.50494 12.9448 3.75218 13.3152 4.13333 13.3913C4.51449 13.4675 4.88532 13.2205 4.96152 12.8398L5.41142 10.5928H7.35431L7.8042 12.8398C7.88045 13.2208 8.25143 13.4675 8.63239 13.3914C9.01355 13.3152 9.26078 12.9448 9.18454 12.5641ZM5.69296 9.18675L6.25603 6.37459H6.5097L7.07277 9.18675H5.69296Z" fill="white"/>
                                    <path d="M20.4596 10.5926H18.3481V9.88956C18.3481 9.5013 18.0329 9.18652 17.6442 9.18652C17.2555 9.18652 16.9404 9.5013 16.9404 9.88956V10.5926H14.8288C14.4401 10.5926 14.125 10.9074 14.125 11.2956C14.125 11.6839 14.4401 11.9987 14.8288 11.9987H14.9992C15.4002 13.2928 16.004 14.2862 16.6685 15.0822C16.1277 15.5763 15.5805 15.9815 15.093 16.371C14.7895 16.6135 14.7403 17.0559 14.9831 17.3591C15.2261 17.6625 15.669 17.7114 15.9724 17.4689C16.4626 17.0772 17.0501 16.6419 17.6442 16.0973C18.2388 16.6423 18.8274 17.0784 19.316 17.4689C19.6196 17.7115 20.0625 17.6623 20.3053 17.3591C20.5481 17.0559 20.4989 16.6135 20.1954 16.371C19.7092 15.9824 19.1613 15.5768 18.62 15.0822C19.2844 14.2862 19.8882 13.2928 20.2893 11.9987H20.4596C20.8483 11.9987 21.1634 11.6839 21.1634 11.2956C21.1634 10.9074 20.8483 10.5926 20.4596 10.5926ZM17.6442 14.049C17.1949 13.4856 16.7907 12.8132 16.486 11.994H18.8024C18.4977 12.8132 18.0935 13.4856 17.6442 14.049Z" fill="white"/>
                                    <path d="M21.913 4.26512H11.7588L11.4571 1.8475C11.3253 0.794249 10.4246 0 9.36192 0H2.11153C0.947233 0 0 0.946153 0 2.10912V17.6229C0 18.7859 0.947233 19.732 2.11153 19.732H8.04648L8.34435 22.1496C8.47592 23.2008 9.37665 23.9971 10.4396 23.9971H21.913C23.0773 23.9971 24.0245 23.051 24.0245 21.888V6.37424C24.0245 5.21127 23.0773 4.26512 21.913 4.26512ZM2.11153 18.3259C1.72343 18.3259 1.40769 18.0106 1.40769 17.6229V2.10912C1.40769 1.72147 1.72343 1.40608 2.11153 1.40608H9.36192C9.71614 1.40608 10.0164 1.6708 10.0603 2.02166C10.1623 2.83888 11.9939 17.5153 12.095 18.3259H2.11153ZM9.70009 21.6419L9.46477 19.732H11.3531L9.70009 21.6419ZM22.6168 21.888C22.6168 22.2757 22.3011 22.591 21.913 22.591H10.7394L13.4189 19.4952C13.5561 19.3407 13.6175 19.1355 13.5892 18.9316L11.9343 5.6712H21.913C22.3011 5.6712 22.6168 5.98658 22.6168 6.37424V21.888Z" fill="white"/>
                                </svg> -->
                            </div>
                            <!-- <div class="text-align-right">
                                <svg xmlns="http://www.w3.org/2000/svg" width="11" height="6" viewBox="0 0 11 6" fill="none">
                                    <path d="M5.21182 5.91027C5.32872 6.02597 5.51699 6.02597 5.63389 5.91027L10.5876 1.00736C10.7781 0.818826 10.6446 0.494141 10.3766 0.494141H0.469137C0.20112 0.494141 0.0676098 0.818826 0.258101 1.00736L5.21182 5.91027Z" fill="white"/>
                                </svg>
                            </div> -->
                        </div>
            ...
            <div class="col-40 text-align-center">
                <div class="registranstion registraion-text text-color-white">{{ $root.trans.registration }}</div>
            </div>
            <!-- <div class="col-33 text-align-right">
                <a class="link icon-only" href="/favourites/">
                    <i class="f7-icons size-22 text-color-white padding font-18">heart_fill</i>
                </a>
            </div> -->
        </div>
    </div>
