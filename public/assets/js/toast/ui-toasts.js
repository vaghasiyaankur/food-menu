!(function () {
  ...
  $(function () {
      ...
      $("#closeButton").on("click", function () {
          ...
          $("#showtoast").on("click", function () {
              var t = $("#toastTypeGroup input:radio:checked").val(),
                  ...
                  o =
                      ...
                      m != toastr.options.positionClass && ((toastr.options.hideDuration = 0), toastr.clear()),
                      ...
                      h && ((e = (e = o) || "Clear itself?"), (o = e += '<br /><br /><button type="button" class="btn btn-secondary clear">Yes</button>'), (toastr.options.tapToDismiss = !1)),
                      o ||
                          (m = [
          ...
          var toastTime = $(".toast.toast-ex").attr('data-bs-delay');

          if (toastTime) {
            setTimeout(() => {
              $(".toast-header .btn-close").click();
            }, toastTime);
          }
  });
