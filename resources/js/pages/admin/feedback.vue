            ...
            <div class="feedback_info">
                <div class="table_search_filter">
                    <div class="search_bar_left">
                        ...
                        <select name="" id="select_filter" placeholder="Rating">
                            <option value="1">All</option>
                            <option value="2">Excited</option>
                            <option value="3">Happy</option>
                            <option value="4">Average</option>
                            <option value="5">Up Set</option>
                        </select>
                        <select name="" id="select_filter" placeholder="Comments">
                            <option value="1">All</option>
                            <option value="2">With Comment</option>
                            <option value="3">Without Comment</option>
                        </select>
                    </div>
                ...
                <div class="feedback_table_wrapper">
                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="customer-detail">
                                        <div class="customer-img">
                                            <img src="\assets\images\seederImages\dashboard\feedback_1.png">
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="customer-detail">
                                        <div class="customer-img">
                                            <img src="\assets\images\seederImages\dashboard\feedback_2.png">
                                        </div>
                                        <div class="customer-name">Jessica William</div>
                                    </div>
                                </td>
                                <td>8258340744</td>
                                <td>Duis sequi sed labor Officiis a officia c </td>
                                <td>24, Sep 2022 / 10:00 am</td>
                                <td>
                                    <a href="" class="delete_btn">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="customer-detail">
                                        <div class="customer-img">
                                            <img src="\assets\images\seederImages\dashboard\feedback_3.png">
                                        </div>
                                        <div class="customer-name">Jessica William</div>
                                    </div>
                                </td>
                                <td>8258340744</td>
                                <td>Esse magni similiqu Mollitia sint velit Sit amet commodo su Voluptatem sit</td>
                                <td>24, Sep 2022 / 10:00 am</td>
                                <td>
                                    <a href="" class="delete_btn">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                            ...
                            <tr>
                                ...
                                <td>8258340744</td>
                                <td>Ad et officia ipsum Assumenda nisi at hi Cum consequuntur in... <a href="">MORE</a></td>
                                <td>24, Sep 2022 / 10:00 am</td>
                                <td>
                                    <a href="" class="delete_btn">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="customer-detail">
                                        <div class="customer-img">
                                            <img src="\assets\images\seederImages\dashboard\feedback_4.png">
                                        </div>
                                        <div class="customer-name">Jessica William</div>
                                    </div>
                                </td>
