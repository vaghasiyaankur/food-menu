    ...
    <f7-page>
        <div class="product-list-section" @click="clickout">
            <div class="product_list_card no-margin">
                ...
                <div class="card-content add-combo">
                    <div
                        class="grid grid-cols-5 medium-grid-cols-4 grid-gap-25 grid-gap-20 align-items-center add-list food-ingredient-list">
                        <div class="bg-color-white data-card">
                            <div class="combo-image"><img src="\assets\images\seederImages\Ingredients\Onion.png">
                            </div>
        ...
        <div class="DeleteProductPopup">
            <div class="delete-product-form">
                ...
                <h4 class=" no-margin delete-data-warning-text">Are you sure delete the Product?</h4>
