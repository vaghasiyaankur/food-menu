...
class ReportController extends Controller
{
    ...
    */
    ...
    public function reportData(Request $request)
    {
        ...
        $all_orders = Order::whereDate('created_at', '>=', $from_date)->whereDate('created_at', '<=', $to_date)->select(DB::raw('DATE(created_at) as date'), DB::raw('count(*) as orders'))->groupBy('date')->get();
