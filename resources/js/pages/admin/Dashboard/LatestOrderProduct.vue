    ...
    <div class="complete_order-product_tables">
        <div class="latest_completed_orders_table">
            ...
            <table>
                ...
                <tbody>
                    <template v-if="latestCompletedOrders.length > 0">
                        ...
                        <tr v-if="latestCompletedOrders.length < 8"><td colspan="3"></td></tr>
                    </template>
            ...
            <table>
                ...
                <tbody>
                    <template v-if="latestProducts.length > 0">
                        ...
                        <tr v-if="latestProducts.length < 8"><td colspan="3"></td></tr>
                    </template>
