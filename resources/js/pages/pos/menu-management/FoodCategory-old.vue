    ...
    <f7-page>
        ...
        <div class="popup categoryPopup">
            <div class="data-form">
                <div class="text-align-center popup_title">
                    Add Category</div>
                <div class="data-add">
                    <label class="add-data-name">Add category name</label>
                    <div class="data-name text-align-left">
                        <input type="text" class="add-update-data-name" placeholder="Add category name">
                    </div>
                    <div class="data-image-selection">
        ...
        <div class="popup EditCategoryPopup">
            <div class="data-form">
                <div class="text-align-center popup_title">
                    edit Category</div>
                <div class="data-add">
                    <label class="add-data-name">Category name</label>
                    <div class="data-name text-align-left">
                        <input type="text" class="add-update-data-name" placeholder="Add category name">
                    </div>
                    <div class="data-image-selection">
        ...
        <div class="popup DeleteCategoryPopup">
            <div class="delete-data-form">
                ...
                <h4 class=" no-margin delete-data-warning-text">Are you sure delete the category?</h4>
                <div class="display-flex justify-content-center popup_button">
                    <button type="button"
                        class="button button-raised button-large popup-close popup-cancel-button">Cancel</button>
                    <button type="button" class="button button-raised button-large popup-ok-button">Ok</button>
